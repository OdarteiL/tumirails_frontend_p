...
class UpdateApplianceRequest extends FormRequest
{
    ...
    public function authorize(): bool
    {
        ...
        // Check if user owns this appliance
        return $appliance->owner_id === $user->id && $appliance->owner_type === get_class($user);
    }
    ...
    public function rules(): array
    {
        return [
            ...
            // Prevent users from changing is_public (only admins can)
    ...
    public function messages(): array
    {
        return [
            ...
            'is_public.prohibited' => 'You cannot change the public status of an appliance',
        ];
    }
