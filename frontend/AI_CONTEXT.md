...
- State: Angular services with RxJS; keep services focused per domain; avoid God-services
...
- Use RxJS observables with proper error handling; centralize error handling
